...
Example for Heavycoin Mining on heavycoinpool.com with a single gpu in your system
    vertminer -t 1 -a heavy -o stratum+tcp://stratum01.heavycoinpool.com:5333 -u <<username.worker>> -p <<workerpassword>> -v 8


Example for Heavycoin Mining on hvc.1gh.com with a dual gpu in your system
    vertminer -t 2 -a heavy -o stratum+tcp://hvcpool.1gh.com:5333/ -u <<WALLET>> -p x -v 8


Example for Fuguecoin solo-mining with 4 gpu's in your system and a Fuguecoin-wallet running on localhost
    vertminer -q -s 1 -t 4 -a fugue256 -o http://localhost:9089/ -u <<myusername>> -p <<mypassword>>


Example for Fuguecoin pool mining on dwarfpool.com with all your GPUs
    vertminer -q -a fugue256 -o stratum+tcp://erebor.dwarfpool.com:3340/ -u YOURWALLETADDRESS.1 -p YOUREMAILADDRESS


Example for Groestlcoin solo mining
    vertminer -q -s 1 -a groestl -o http://127.0.0.1:1441/ -u USERNAME -p PASSWORD


Example for Scrypt-N (2048) on Nicehash
    vertminer -a scrypt:10 -o stratum+tcp://stratum.nicehash.com:3335 -u 3EujYFcoBzWvpUEvbe3obEG95mBuU88QBD -p x
...
With the -b parameter you can open your vertminer to your network, use -b 0.0.0.0:4068 if required.
...
>>> RELEASE HISTORY <<<
  ...
  May 26th 2015   v1.6.4
                  Implement multi-pool support (failover and time rotate)
                    try "vertminer -c pools.conf" to test the sample config
  ...
  Feb. 11th 2015  v1.5.3
                  Fix anime algo
                  Allow a default config file in user or vertminer folder
  ...
  March, 24 2014  fixed Groestl pool support
                  ...
                  default after numerous reports of vertminer v0.2/v0.3
